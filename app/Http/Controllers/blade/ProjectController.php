...
class ProjectController extends Controller
{
    ...
    {
        $incomingEntities = \App\Models\IncomingEntity::query()
            ->orderBy('name')
            ->get();

        $contractors = \App\Models\Contractor::query()
            ->orderBy('name')
            ->get();
    ...
    public function edit(Project $project): View
    {
        ...
        $pricingItemsData = $pricingItems->map(function ($item) {
            return [
                'id' => $item->id,
                'name' => $item->name,
                'unit' => $item->unit,
