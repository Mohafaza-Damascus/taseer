        ...
        <section class="page-header">
            ...
            <div class="header-main">
                ...
                <div class="header-actions">
                    ...
                    <a href="{{ route('projects.edit', $project) }}" class="btn-icon-edit">
                        تعديل المشروع
                    </a>
            ...
            <section class="info-grid">
                ...
                <div class="info-card">
                    ...
                    <div class="info-card-header">
                        ...
                        @if ($project->incomingEntity)

                                                <a href="{{ route(
                                'projects.edit',
                                $project->incomingEntity
                            ) }}" class="btn-icon-edit" aria-label="تعديل بيانات الجهة الواردة">
                    ...
                    <div class="info-item">
                        ...
                        <span>
                            {{ $project->incomingEntity?->notes ?? 'لا توجد ملاحظات' }}
                        </span>
                ...
                <div class="info-card">
                    ...
                    <div class="info-card-header">
                        ...
                        @if ($project->contractor)
                                ...
                                'projects.edit',
                                $project->contractor
                            ) }}" class="btn-icon-edit" aria-label="تعديل بيانات المقاول">
                    ...
                    <div class="info-item">
                        ...
                        <span dir="ltr">
                            {{ $project->contractor?->phone ?? 'غير محدد' }}
                        </span>
                    ...
                    <div class="info-item">
                        ...
                        <span>
                            {{ $project->contractor?->national_number ?? 'غير محدد' }}
                        </span>
                    ...
                    <div class="info-item">
                        ...
                        <span>
                            {{ $project->contractor?->company_name ?? 'غير محددة' }}
                        </span>
                ...
                <div class="info-card">
                    ...
                    <div class="info-item">
                        ...
                        <span>
                            {{ $project->signing_location ?? 'غير محدد' }}
                        </span>
                    ...
                    <div class="info-item">
                        ...
                        <span>
                            {{ $project->start_date?->format('Y-m-d') ?? 'غير محدد' }}
                        </span>
                    ...
                    <div class="info-item">
                        ...
                        <span>
                            {{ $project->end_date?->format('Y-m-d') ?? 'غير محدد' }}
                        </span>
